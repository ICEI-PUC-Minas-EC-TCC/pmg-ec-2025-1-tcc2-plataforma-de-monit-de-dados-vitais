...
export const stopLocationTracking = async (
  ...
  try {
    ...
    const activityData = {
      ...
      heartRateMax: vitalSignsStats.heartRateMax,
      heartRateMed: vitalSignsStats.heartRateMed,
      heartRateMin: vitalSignsStats.heartRateMin,
      oxygenLevelMax: vitalSignsStats.oxygenLevelMax,
      oxygenLevelMed: vitalSignsStats.oxygenLevelMed,
      oxygenLevelMin: vitalSignsStats.oxygenLevelMin,
